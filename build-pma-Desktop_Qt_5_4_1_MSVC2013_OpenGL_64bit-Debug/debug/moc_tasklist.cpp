...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_tasklist_t, stringdata) + ofs \
...
const QMetaObject tasklist::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_tasklist.data,
...
void *tasklist::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_tasklist.stringdata))
